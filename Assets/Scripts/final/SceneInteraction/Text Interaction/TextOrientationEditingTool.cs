...
public class TextOrientationEditingTool : ISceneInteractionTool
{
    ...
    public void StartInteraction()
    {
        ...
        RuntimeInteractionData.isEditingTextOrientation = true;
    ...
    public void StopInteraction()
    {
        ...
        RuntimeInteractionData.isEditingTextOrientation = false;
        hoveredObject = null;
