...
public class GraphicsInfoBuffer : MonoBehaviour
{
    ...
    public void SetUpBuffer()
    {
        ...
        graphicsBuffer = new GraphicsBuffer(GraphicsBuffer.Target.Structured, letterCount,
            System.Runtime.InteropServices.Marshal.SizeOf(typeof(OldLetterStruct)));
    ...
    public void UpdateBuffer(OldLetterStruct[] letterStructs)
    {
        //DEBUG
